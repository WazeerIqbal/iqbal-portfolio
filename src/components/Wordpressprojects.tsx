                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    ...
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-1">
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bussiness} alt="Bonnie Avatar" />
                                ...
                                <ul className="flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="https://www.linkedin.com/in/iqbal-rasool-a60425212/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                            <svg className='invert-svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
                                    ...
                                    <li>
                                        <a href="https://github.com/WazeerIqbal" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                            <img src={githubsvg} className='invert-svg' alt="" />
                                        </a>
                                    </li>
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={ecom} alt="Jese Avatar" />
                            </a>
                            <div className="p-5">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    Ecommerce Websites
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={marketplace} alt="Michael Avatar" />
                            </a>
                            <div className="p-5">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
