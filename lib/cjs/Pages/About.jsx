...
var fulltime_svg_1 = __importDefault(require("../images/fulltime.svg"));
var internship_svg_1 = __importDefault(require("../images/internship.svg"));
var About = function () {
    return (<div>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4 font-light"> SEO Expert & Junior Web Developer.</p>
              <img src={fulltime_svg_1.default} alt=""/>
              <br />
          ...
          <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4 font-light">
            <img src={internship_svg_1.default} alt=""/>
            <br />
